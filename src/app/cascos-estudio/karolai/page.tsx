...
const CaseStudyContent = () => (
    <article className="prose prose-lg max-w-4xl mx-auto py-16 px-6 lg:px-8 text-gray-700 font-light prose-headings:font-light prose-headings:text-gray-900 prose-h2:text-3xl prose-a:text-emerald-600 hover:prose-a:text-emerald-500">
        <h2>El Desafío: Escalar la Comunicación Sin Perder el Toque Humano</h2>
        <p>
        ...
        <h2>La Solución: Una Plataforma de Orquestación de IA</h2>
        <p>
        ...
        <ol>
            <li>
                <strong>Constructor de Flujos Visual "No-Code":</strong> Desarrollamos una interfaz de arrastrar y soltar utilizando React y la librería React Flow, permitiendo a los usuarios diseñar flujos de conversación complejos sin escribir una sola línea de código. Cada nodo en el flujo podía realizar acciones, desde enviar un mensaje hasta integrarse con una API externa.
            </li>
            <li>
            ...
            <li>
                <strong>Integraciones Poderosas:</strong> Construimos un sistema de "conectores" que permitía a la plataforma interactuar con herramientas de terceros como Google Calendar (para agendar citas), Hubspot (para actualizar CRM) y Google Sheets (para registrar datos), enriqueciendo las conversaciones y automatizando procesos de negocio completos.
            </li>
            <li>
        ...
        <h2>Implementación y Colaboración Ágil</h2>
        <p>
        ...
        <p>
            Utilizamos Docker para la contenedorización de los microservicios, lo que nos permitió mantener la coherencia entre los entornos de desarrollo, pruebas y producción. La integración y el despliegue continuo (CI/CD) se gestionaron a través de GitHub Actions, automatizando las pruebas y los despliegues y permitiendo a nuestro equipo centrarse en la entrega de valor.
        </p>

        <Testimonial />

        <h2>Conclusión: De la Visión a la Realidad</h2>
        <p>
