    ...
    <main className="relative z-20 max-w-lg p-8">
      <div className="text-left">
        ...
        <div className="flex items-center gap-4 flex-wrap">
          <a href="#casos-exito" className="px-8 py-3 rounded-full bg-transparent border border-white/30 text-white font-normal text-sm transition-all duration-200 hover:bg-white/10 hover:border-white/50 cursor-pointer">
            Ver Casos de Éxito
          </a>
          <a href="#contacto" className="px-8 py-3 rounded-full bg-white text-black font-normal text-sm transition-all duration-200 hover:bg-white/90 cursor-pointer">
            Consulta Gratuita
          </a>
        </div>
      </div>
